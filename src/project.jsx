        ...
        <main>
          <div className={styles["project-item"]}>
            <div className={styles["project-item-img-container"]}>
              <img src="/images/Charizard X.png" alt="1" border="0" />
            </div>
          ...
          <div className={styles["project-item"]}>
            <div className={styles["project-item-img-container"]}>
              <img src="/images/Torterra.png" alt="1" border="0" />
            </div>
            <div className={styles["project-item-desc"]}>
              <div className={styles["project-title"]}>
                <h2>NorthExpo</h2>
          ...
          <div className={styles["project-item"]}>
            <div className={styles["project-item-img-container"]}>
              <img src="images/Arcanine.png" alt="1" border="0" />
            </div>
            <div className={styles["project-item-desc"]}>
              <div className={styles["project-title"]}>
                <h2>Rora Cake</h2>
          ...
          <div className={styles["project-item"]}>
            <div className={styles["project-item-img-container"]}>
              <img src="images/Blastoise.png" alt="1" border="0" />
            </div>
            <div className={styles["project-item-desc"]}>
              <div className={styles["project-title"]}>
                <h2>Sancode</h2>
